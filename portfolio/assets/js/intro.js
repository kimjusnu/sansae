 ...
 *
 * Runs on every load by request. It still yields to reduced-motion, to deep
 * links (a shared #work URL should land on the section, not a splash), and to
 * Escape at any moment. It also buys time to warm the sequence's first frames.
 */
(function () {
  'use strict';
