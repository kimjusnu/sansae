...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'work.2.tag': 'SaaS',
      'work.2.p':
        'A SaaS for authoring, reviewing and managing quizzes. I designed the modular editor and the review workflow, and automated deployment with GitHub Actions on a self-hosted EC2 runner. The multi-stage Dockerfile kept failing because the instance ran out of disk, so I moved it to PM2 and shipped. I also found that the delete-attachment API let you delete other people\'s files, and wrote up owner verification and per-user API separation as the fix.',
